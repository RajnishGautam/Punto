...
const WebServices = () => {
  ...
  const services = [
    {
      ...
      description: "Scalable, high-performance web applications built with cutting-edge technologies",
      features: ["React/Vue.js", "Node.js Backend", "Cloud Integration", "Real-time Features"],
      icon: "🚀",
      color: "#00D4FF"
    },
    {
      ...
      description: "Complete online stores with seamless payment integration and inventory management",
    ...
    },
    {
      ...
      description: "Fast, reliable web apps that work offline and provide native app-like experience",
      features: ["Offline Capability", "Push Notifications", "App-like Feel", "Cross-Platform"],
      icon: "📱",
      color: "#00D4FF"
    },
    {
      ...
      description: "Large-scale web applications designed for enterprise-level performance and security",
      features: ["Microservices", "High Security", "Scalable Architecture", "API Integration"],
      icon: "🏢",
      color: "#00D4FF"
    }
  ];
  ...
  useEffect(() => {
    ...
    const webdevCards = sectionRef.current?.querySelectorAll('.service-webdevcard');
        ...
        <div className="services-grid">
          {services.map((service, index) => (
            <div
              ...
              style={{ '--service-color': service.color, '--delay': `${index * 0.2}s` }}
            >
