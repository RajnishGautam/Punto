      ...
      <div className="app-services-container">
        ...
        <div className="app-services-grid">
          <div className="service-highlight">
            ...
            <p>
              Tailored mobile apps that perfectly match your business
              requirements
            </p>
          </div>
          <div className="service-highlight">
            ...
            <p>
              Optimized performance ensuring smooth user experience across all
              devices
            </p>
          </div>
          <div className="service-highlight">
            ...
            <p>
              Enterprise-grade security with robust architecture and data
              protection
            </p>
          </div>
          <div className="service-highlight">
            ...
            <p>
              Intuitive interfaces designed to engage users and drive
              conversions
            </p>
          </div>
        </div>
