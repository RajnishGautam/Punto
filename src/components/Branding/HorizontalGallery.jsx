  ...
  return (
    <div className="hg-gallery-main-container">
      ...
      <div className="hg-gallery-header">
        <h1 className="hg-gallery-title">BOLD BRANDS. REAL IMPACT.</h1>
        <p className="hg-gallery-subtitle">
          Visual identities that elevate your business and make you
          unforgettable.
        </p>
      </div>
            ...
            return (
              ...
              >
                ...
                <div className={`hg-vertical-title ${isActive ? 'hg-active' : 'hg-inactive'}`}>
                  <h3 className="hg-vertical-text">{`Brand ${index + 1}`}</h3>
                </div> */}
