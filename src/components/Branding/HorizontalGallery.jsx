...
const HybridGallery = () => {
  ...
  const images = [
    ...
    },
    {
      ...
      title: "Happispace",
      description: "Towering peaks and serene alpine lakes in the heart of the mountains."
      },
      {
        id: 12,
        src: "/branding/brand12.JPG",
        title: "Country Made",
        description: "Endless ocean views and sun-kissed beaches in a tranquil coastal setting."
        },
        {
          id: 13,
        ...
        },
    {
      ...
      description: "Golden sands and dramatic sunsets in the heart of the desert."
    },
    {
      id: 15,
      src: "/branding/brand15.JPG",
      title: "Fizzy Goblet",
      description: "Crystal clear rivers winding through lush valleys and mountains."
    }
  ];
